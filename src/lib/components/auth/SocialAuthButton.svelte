...
<button
	class="flex w-full cursor-pointer items-center justify-center gap-5 rounded-[10px] border border-[#DDDDDD] bg-[#EEEEEE] p-2.5 delay-100 hover:bg-[#DDDDDD]"
	onclick={async () => {
		await signIn.social({
			provider,
			callbackURL
...
>
	<!-- <img src="/logos/google.png" alt={`${provider} logo`} class="h-4 w-4" /> -->
