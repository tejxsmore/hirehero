	...
	<div class="flex w-full justify-center p-5">
		<div class="w-full max-w-md space-y-10">
			<div class="p-5 text-center">
				...
				<p class="pt-2.5 text-[#6c757d]">Welcome! Sign up to continue</p>
			</div>
			...
			<form method="POST" class="space-y-5">
				<div class="flex gap-5">
					<div
						class="flex flex-1 items-center rounded-[10px] border border-[#272829] bg-[#191919] px-5 py-2.5"
					>
						<User class="mr-5 h-4 w-4 text-[#454545]" />
						<input
							type="text"
							name="firstname"
							id="firstname"
