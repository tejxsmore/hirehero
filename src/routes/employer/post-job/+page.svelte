	...
	<div class="flex w-full justify-center">
		<div class="w-full max-w-4xl space-y-10 p-5">
			<div class="space-y-2.5 py-5 text-center">
				...
				<p class="text-gray-400">Find the perfect candidate for your open position</p>
			</div>

			<form method="post" action="?/post" class="space-y-10" onsubmit={handleSubmit}>
				<!-- Job Basic Information -->
				<div class="rounded-[15px] border border-[#DDDDDD] bg-white p-5">
					<h3 class="mb-5 text-lg font-semibold text-gray-800">Basic Information</h3>

					<div class="grid gap-5 md:grid-cols-2">
						<!-- Job Title -->
						<div class="space-y-1 md:col-span-2">
							<label for="title" class="block text-sm font-medium text-gray-700">
								Job Title <span class="text-[#FF4C29]">*</span>
							</label>
							<div
						...
						<div class="space-y-1">
							<label for="type" class="block text-sm font-medium text-gray-700">
								Job Type <span class="text-[#FF4C29]">*</span>
							</label>
							<div class="relative">
								<div
									class="flex items-center rounded-[10px] border border-[#DDDDDD] bg-[#EEEEEE] px-5 py-2.5 focus-within:ring-2 focus-within:ring-[#DDDDDD]"
					...
					<div class="mt-5 space-y-1">
						<label for="description" class="block text-sm font-medium text-gray-700">
							Job Description (Markdown) <span class="text-[#FF4C29]">*</span>
						</label>
						<div
							class="flex rounded-[10px] border border-[#DDDDDD] bg-[#EEEEEE] px-5 py-2.5 focus-within:ring-2 focus-within:ring-[#DDDDDD]"
						>
							<textarea
								id="description"
								name="description"
				...
				<!-- Compensation -->
				<div class="rounded-[15px] border border-[#DDDDDD] bg-white p-5">
					<h3 class="mb-5 text-lg font-semibold text-gray-800">Compensation</h3>

					<div class="grid gap-5 md:grid-cols-3">
						<!-- Salary Range -->
						<div class="space-y-1">
							<label for="salaryMin" class="block text-sm font-medium text-gray-700">
								Minimum Salary <span class="text-[#FF4C29]">*</span>
							</label>
							<div
								class="flex items-center rounded-[10px] border border-[#DDDDDD] bg-[#EEEEEE] px-5 py-2.5 focus-within:ring-2 focus-within:ring-[#DDDDDD]"
							>
						...
						<div class="space-y-1">
							<label for="salaryMax" class="block text-sm font-medium text-gray-700">
								Maximum Salary <span class="text-[#FF4C29]">*</span>
							</label>
							<div
								class="flex items-center rounded-[10px] border border-[#DDDDDD] bg-[#EEEEEE] px-5 py-2.5 focus-within:ring-2 focus-within:ring-[#DDDDDD]"
							>
						...
						<div class="space-y-1">
							<label for="salaryCurrency" class="block text-sm font-medium text-gray-700">
								Currency
							</label>
							<div class="relative">
								<div
						...
						<div class="space-y-1 md:col-span-3">
							<label for="salaryType" class="block text-sm font-medium text-gray-700">
								Salary Type <span class="text-[#FF4C29]">*</span>
							</label>
							<div class="relative">
								<div
									class="flex items-center rounded-[10px] border border-[#DDDDDD] bg-[#EEEEEE] px-5 py-2.5 focus-within:ring-2 focus-within:ring-[#DDDDDD]"
				...
				<!-- Requirements -->
				<div class="rounded-[15px] border border-[#DDDDDD] bg-white p-5">
					<h3 class="mb-5 text-lg font-semibold text-gray-800">Requirements</h3>
					...
					<!-- Skills -->
					<div class="mt-5 space-y-1">
						<label for="skillInput" class="block text-sm font-medium text-gray-700">
							Required Skills
						</label>
						<div class="flex items-center gap-5">
							<!-- Input container with border and padding -->
							<div class="flex-1 rounded-[10px] border border-[#DDDDDD] bg-[#EEEEEE] px-5 py-2.5">
								<input
									type="text"
									id="skillInput"
									name="skillInput"
							...
							<button
								type="button"
								onclick={addSkill}
								class="cursor-pointer rounded-[10px] border border-[#FFE8CD] bg-[#FFE8CD] px-5 py-2.5 font-medium text-[#FF4C29] transition hover:opacity-80"
							>
								Add
							</button>
						</div>
						...
						{#if formData.skills.length > 0}
							<div class="mt-3 flex flex-wrap gap-2">
								{#each formData.skills as skill}
									<span
										class="inline-flex items-center rounded-full bg-[#EEEEEE] px-3 py-1 text-sm text-gray-700"
									>
										{skill}
										<button
											type="button"
											onclick={() => removeSkill(skill)}
											class="ml-3 cursor-pointer text-gray-400 hover:text-gray-700"
										>
											<X size="16" />
										</button>
									</span>
				...
				<!-- Location -->
				<div class="rounded-[15px] border border-[#DDDDDD] bg-white p-5">
					<h3 class="mb-5 text-lg font-semibold text-gray-800">Location</h3>

					<div class="grid gap-5 md:grid-cols-2">
						<!-- Location Type -->
						<div class="space-y-1 md:col-span-2">
							<label for="locationType" class="block text-sm font-medium text-gray-700">
								Location Type <span class="text-[#FF4C29]">*</span>
							</label>
							<div class="relative">
								<div
									class="flex items-center rounded-[10px] border border-[#DDDDDD] bg-[#EEEEEE] px-5 py-2.5 focus-within:ring-2 focus-within:ring-[#DDDDDD]"
				...
				<!-- Application Method -->
				<div class="rounded-[15px] border border-[#DDDDDD] bg-white p-5">
					<h3 class="mb-5 text-lg font-semibold text-gray-800">Application Method</h3>
					...
					<div class="grid gap-5 md:grid-cols-2">
						...
						<!-- Application Email -->
						<div class="space-y-1">
							<label for="applicationEmail" class="block text-sm font-medium text-gray-700">
								Application Email
							</label>
							<div
								class="flex items-center rounded-[10px] border border-[#DDDDDD] bg-[#EEEEEE] px-5 py-2.5 focus-within:ring-2 focus-within:ring-[#DDDDDD]"
				...
				<!-- Job Settings -->
				<div class="rounded-[15px] border border-[#DDDDDD] bg-white p-5">
					<h3 class="mb-5 text-lg font-semibold text-gray-800">Job Settings</h3>
					...
					<div class="space-y-5">
						...
						<div class="flex items-center gap-5">
							...
							<button
								type="button"
								onclick={togglePublished}
								class="cursor-pointer text-sm leading-relaxed text-gray-700"
							>
				...
				<div class="flex gap-5">
					<button
						type="button"
						class="cursor-pointer rounded-full border border-gray-300 bg-white px-5 py-2.5 font-medium text-gray-700 transition-all duration-100 hover:bg-gray-50 focus:outline-none"
					>
						Cancel
					</button>
					<button
						type="submit"
						class="flex-1 cursor-pointer rounded-full border border-[#E6521F] bg-[#FF4C29] px-5 py-2.5 font-medium text-white transition-all duration-100 hover:bg-[#EA2F14] focus:outline-none"
					>
